...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dataset-name",
        required=True,
        help="Dataset name under benchmarks/demultiplex/data and benchmarks/demultiplex/tools.",
    )
    parser.add_argument(
        "--tool",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Scratch workspace root for one dataset. Uses <data-dir>/data/<dataset>, <data-dir>/tools/<tool>/<dataset>, and defaults runtime artifacts to <data-dir>/runtime/<dataset>.",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
...
def write_tool_report(
    *,
    ...
    report_dir = TOOLS_ROOT / str(tool_result["tool"]) / dataset_name
    report_dir.mkdir(parents=True, exist_ok=True)
    report_path = report_dir / "timing.json"
    report = {
