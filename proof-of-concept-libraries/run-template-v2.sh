...
delt-hit init --excel_path=/Users/adrianomartinelli/projects/delt/delt-core/proof-of-concept-libraries/template_v2.xlsx
CONFIG_PATH=/Volumes/T7/experiments/experiment-template-v2/config.yaml
