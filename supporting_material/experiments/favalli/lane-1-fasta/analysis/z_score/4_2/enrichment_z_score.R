...
args <- list(
  counts_path = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/favalli/lane-1-fasta/selections/4_2/counts.txt",
  save_dir = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/favalli/lane-1-fasta/analysis/z_score/4_2",
  library_size = 335376
)
