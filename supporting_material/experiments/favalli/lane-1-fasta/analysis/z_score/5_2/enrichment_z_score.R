...
args <- list(
  counts_path = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/favalli/lane-1-fasta/selections/5_2/counts.txt",
  save_dir = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/favalli/lane-1-fasta/analysis/z_score/5_2",
  library_size = 335376
)
