...
args <- list(
  counts_path = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/favalli/lane-1/selections/4_2/counts.txt",
  save_dir = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/favalli/lane-1/analysis/z_score/4_2",
  library_size = 335376
)
