...
args <- list(
  data_path = "/work/FAC/FBM/DBC/mrapsoma/prometex/projects/delt-hit/supporting_material/experiments/pure-del/lane-1/analysis/dyna_sp/data.csv",
  samples_path = "/work/FAC/FBM/DBC/mrapsoma/prometex/projects/delt-hit/supporting_material/experiments/pure-del/lane-1/analysis/dyna_sp/samples.csv",
  save_dir = "/work/FAC/FBM/DBC/mrapsoma/prometex/projects/delt-hit/supporting_material/experiments/pure-del/lane-1/analysis/dyna_sp/counts",
  cpm      = FALSE
)
