...
args <- list(
  data_path = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/pure-del/lane-2/analysis/his_pure_up/data.csv",
  samples_path = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/pure-del/lane-2/analysis/his_pure_up/samples.csv",
  save_dir = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/pure-del/lane-2/analysis/his_pure_up/counts",
  cpm      = FALSE
)
