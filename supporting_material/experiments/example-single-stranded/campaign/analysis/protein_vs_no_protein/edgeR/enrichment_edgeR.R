...
args <- list(
  ...
  save_dir     = "/work/FAC/FBM/DBC/mrapsoma/prometex/projects/delt-hit/supporting_material/experiments/example-single-stranded/campaign/analysis/protein_vs_no_protein/edgeR",
  log          = FALSE
)
