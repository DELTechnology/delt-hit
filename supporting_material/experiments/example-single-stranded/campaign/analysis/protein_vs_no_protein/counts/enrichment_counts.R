...
args <- list(
  data_path = "/work/FAC/FBM/DBC/mrapsoma/prometex/projects/delt-hit/supporting_material/experiments/example-single-stranded/campaign/analysis/protein_vs_no_protein/data.csv",
  samples_path = "/work/FAC/FBM/DBC/mrapsoma/prometex/projects/delt-hit/supporting_material/experiments/example-single-stranded/campaign/analysis/protein_vs_no_protein/samples.csv",
  save_dir = "/work/FAC/FBM/DBC/mrapsoma/prometex/projects/delt-hit/supporting_material/experiments/example-single-stranded/campaign/analysis/protein_vs_no_protein/counts",
  cpm      = FALSE
)
