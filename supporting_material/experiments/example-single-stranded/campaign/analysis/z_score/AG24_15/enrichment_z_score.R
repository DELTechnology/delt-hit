...
args <- list(
  counts_path = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/example-single-stranded/campaign/selections/AG24_15/counts.txt",
  save_dir = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/example-single-stranded/campaign/analysis/z_score/AG24_15",
  library_size = 168337
)
