...
args <- list(
  data_path    = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/example-single-stranded/campaign/analysis/edgeR/condition_vs_control/data.csv",
  samples_path = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/example-single-stranded/campaign/analysis/edgeR/condition_vs_control/samples.csv",
  save_dir     = "/Users/adrianomartinelli/projects/delt-hit/supporting_material/experiments/example-single-stranded/campaign/analysis/edgeR/condition_vs_control",
  log          = FALSE
)
