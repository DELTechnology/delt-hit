...
15 & Chemical structure errors & Invalid SMILES or incorrect reaction SMIRKS & Validate building block structures with RDKit; check reaction definitions; run enumeration in debug mode \\
