...
\midrule
campaign.fastq.gz & \path{supporting_material/experiments/example-single-stranded/download.sh} & Representative screening data for the single-stranded example \\
