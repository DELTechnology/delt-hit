\phantomsection\subsection*{Supplementary Note 1: Re-analysis of published datasets}

To assess the applicability of DELT-Hit to previously published DEL selections, we re-analysed two literature datasets distributed with the supporting material: the NF2 dataset reported by Favalli et al.\cite{ref38} and the Pure-DEL dataset reported in Science\cite{ref39}.
