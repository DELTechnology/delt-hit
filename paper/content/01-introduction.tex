...
The low- and medium-complexity studies presented here can be analyzed with DELT-Hit in less than 2 hours, including generation of all output files. Re-analyses of the published datasets from Favalli et al. and Keller et al. are summarized in Supplementary Note~\ref{supp:analysis-of-published-datasets}.
