...
This box reproduces the complete DELT-Hit workflow for the single-stranded example dataset provided in the supporting material (see Section~3.3 Data). It is intended as a self-contained reference for users who want to run through the entire pipeline on the provided example before adapting it to their own data. We assume that DELT-Hit has already been installed as described in Box~1.
